    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Stock Transfers</h4>
                    <div class="page-title-right">
                        <button type="button" id="btn-export-transfers" class="btn btn-soft-success btn-label">
                            <i class="ri-file-download-line label-icon align-middle fs-16 me-2"></i> Export
                        </button>
                        <a href="<?= site_url('stock-transfers/new'); ?>" class="btn btn-primary btn-label ms-2">
        ...
        <div class="row g-2 align-items-end mb-3">
            <div class="col-md-3">
                ...
                <div class="form-icon">
                    <input type="text" class="form-control form-control-icon" id="filter-keywords" placeholder="Search by transfer number, locations, transporter" value="<?= esc($filters['keywords']); ?>">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive  min-height-card-body">
                    <table id="transfers-grid" class="table dt-responsive w-100 align-middle table-striped">
