...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="sm" data-sidebar-image="none" data-preloader="disable">
	...
	<body>
						...
						<div class="d-flex">
							...
							<div class="navbar-brand-box horizontal-logo">
								...
								<a href="index.html" class="logo logo-light">
									...
									<span class="logo-lg">
										<img src="<?= site_url('assets/images/logo-light.png'); ?>" alt="" height="17">
									</span>
								</a>
							</div>
									...
									<div data-simplebar style="max-height: 320px;">
										...
										<div class="notification-list">
											...
											<a href="javascript:void(0);" class="dropdown-item notify-item py-2">
												<div class="d-flex">
													<img src="<?= site_url('assets/images/users/user.jpg'); ?>" class="me-3 rounded-circle avatar-xs" alt="user-pic">
						...
						<div class="d-flex align-items-center">
							...
							<div class="dropdown ms-1 topbar-head-dropdown header-item">
								<button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<img id="header-lang-img" src="<?= site_url('assets/images/flags/' . (($current_language ?? 'en') == 'en' ? 'us.svg' : 'in.svg')); ?>" alt="Header Language" height="20" class="rounded">
								</button>
								<div class="dropdown-menu dropdown-menu-end">
									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item language py-2" data-lang="en" title="English">
										<img src="<?= site_url('assets/images/flags/us.svg'); ?>" alt="user-image" class="me-2 rounded" height="18">
										<span class="align-middle">English</span>
									</a>
									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="hi" title="Hindi">
										<img src="<?= site_url('assets/images/flags/in.svg'); ?>" alt="user-image" class="me-2 rounded" height="18">
							...
							<div class="ms-1 header-item d-none d-sm-flex">
								<button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle text-success" id="connection-status">
									<i class="bx bx-wifi fs-22"></i>
								</button>
							</div>
										...
										<div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
											<div data-simplebar style="max-height: 300px;" class="pe-2">
												<div class="d-flex text-muted justify-content-center">
													<div id="select-content" class="text-body fw-semibold px-1">0</div> Result <button type="button" class="btn btn-link link-danger p-0 ms-3" data-bs-toggle="modal" data-bs-target="#removeNotificationModal">Remove</button>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="dropdown ms-sm-3 header-item topbar-user">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a class="dropdown-item" href="<?= site_url('messages'); ?>">
										<i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
										<span class="align-middle">Messages</span>
									</a>
									<a class="dropdown-item" href="<?= site_url('taskboard'); ?>">
				...
				<div id="scrollbar">
					<div class="container-fluid">
						...
						<ul class="navbar-nav" id="navbar-nav">
							...
							<li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-master">Master</span></li>
							<li class="nav-item">
			...
			<div class="main-content">
				...
				<footer class="footer">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<script>document.write(new Date().getFullYear())</script> © KASH IT Solutions Ltd.
							</div>
							<div class="col-sm-6">
								<div class="text-sm-end d-none d-sm-block">
									Design & Develop by KASH IT Solutions Ltd.
								</div>
							</div>
						</div>
					</div>
		...
		<script>
			...
			// Function to check actual server connectivity (in case WiFi is on but no internet)
			function checkInternetConnection() {
				// You can replace '/ping' with any lightweight endpoint
				fetch(SITE_URL + '/ping', { method: 'GET', cache: 'no-cache' })
					.then(response => {
						if (response.ok) {
			...
			// Events for browser-detected online/offline
			...
			// Run check periodically every 5 seconds
			setInterval(() => {
