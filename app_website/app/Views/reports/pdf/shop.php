...
<body>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <span><?= esc($shop['contact_person'] ?? '—') ?></span>
        </div>
        <div class="info-row">
            <span class="info-label">Godown:</span>
            <span><?= esc($shop['godown_name'] ?? '—') ?></span>
        </div>
    ...
    <div style="margin: 20px 0;">
        ...
        <div class="summary-box">
            <div class="summary-value"><?= number_format($summary['total_sales_amount'] ?? 0, 2) ?></div>
            <div class="summary-label">Sales Amount</div>
        </div>
        <div class="summary-box">
    ...
    <!-- Sales -->
    <h2>Sales (<?= $summary['total_sales'] ?? 0 ?> sales, Amount: <?= number_format($summary['total_sales_amount'] ?? 0, 2) ?>)</h2>
    <table>
        <thead>
            <tr>
            ...
            <?php if(!empty($sales)): ?>
                <?php foreach($sales as $sale): ?>
                    <tr>
                        ...
                        <td><?= esc($sale['payment_status'] ?? '—') ?></td>
                        <td class="text-end"><?= number_format((float)($sale['total_amount'] ?? 0), 2) ?></td>
                        <td class="text-end"><?= number_format((float)($sale['final_amount'] ?? 0), 2) ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
