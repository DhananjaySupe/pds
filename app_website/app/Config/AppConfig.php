<?php namespace Config;
	...
	class AppConfig extends BaseConfig
	{
		...
		// API configuration
		public $recognize = array(
			'mxface' => array(
				'enabled' => true,
				'group_id' => '4397',
				'url' => 'https://faceapi.mxface.ai/api/',
				'subscriptionkey' => 'fpAWUBVdjk4ea7K0fi-Yv3uz14XUn3225'
			),
			'luxand' => array(
				'enabled' => false,
				'url' => 'https://api.luxand.cloud/',
				'apitoken' => '4202789f3a274420a08202436d21ad5c'
			),
			'inhouse' => array(
				'enabled' => false,
				'url' => 'https://api.inhouse.com/',
				'apitoken' => '4202789f3a274420a08202436d21ad5c'
			)
		);
