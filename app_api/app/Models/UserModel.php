<?php namespace App\Models;
	...
	class UserModel extends Model
	{
		...
		protected $allowedFields = ['user_id', 'role_id', 'full_name', 'phone', 'email', 'password', 'status', 'otp', 'otp_expiry', 'otp_attempts', 'last_login_at', 'last_login_ip', 'fcm_token', 'code', 'language', 'profile_photo', 'created_by', 'created_at', 'updated_by', 'updated_at'];
